//! Unit tests for the deterministic PRNG pure core (`leap_to_freedom::rng`).
//!
//! Contract under test (plan §4.1 / §4.4):
//! - `Rng::new(s0: u32, s1: u32) -> Rng` — seedable, deterministic PRNG
//!   (xoroshiro64* reused from `wasm/free-haiku/src/rng.rs`).
