#!/usr/bin/env bash
# leap_to_freedom.wasm を wasm32-unknown-unknown 向けにビルドし src/assets へ配置する。
#
...
cp "$SCRIPT_DIR/target/wasm32-unknown-unknown/release/leap_to_freedom.wasm" \
  "$REPO_ROOT/src/assets/leap_to_freedom.wasm"

echo "built: src/assets/leap_to_freedom.wasm"
